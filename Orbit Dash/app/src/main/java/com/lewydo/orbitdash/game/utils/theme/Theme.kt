...
//
// Актори НЕ тримають своїх кольорів — перефарбовуються з ThemeManager.current,
// щойно росте version (ThemeSync: private val themeSync = ThemeSync(::syncTheme)).
// Тому зміна теми — це один виклик switchTo(id): current сам плавно
// перелерпається за TRANSITION_TIME, і все, що намальоване білими
// спрайтами/шейдерами, перефарбується.
//
