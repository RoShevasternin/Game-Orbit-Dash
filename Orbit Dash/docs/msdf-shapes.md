...
- **`-pxrange 8` = від −4 до +4 текселів, край на 0.5.** Досяжність майбутніх
  ефектів — половина діапазону. Для іконок вистачить; для фігур під світіння
  генеруй окремо з `-apxrange -24 4` і більшою клітинкою.
...
- **Батчинг**: `AMsdfGroup`, що виставляє шейдер раз на групу.
